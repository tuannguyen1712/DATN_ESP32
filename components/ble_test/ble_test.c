...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_WRITE_EVT: {
        ...
        if (!param->write.is_prep){
            ESP_LOGI(GATTS_TAG, "GATT_WRITE_EVT, value len %d, value : %s profile x", param->write.len, (char*) (param->write.value));
...
void disable_ble() {
    esp_bluedroid_disable();                   // Disable bluetooth, must prior to esp_bludroid_deinit
